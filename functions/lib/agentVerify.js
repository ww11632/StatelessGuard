...
// Proof-of-Agent 驗證
exports.agentVerify = (0, https_1.onRequest)({ region: REGION, timeoutSeconds: TIMEOUT_SECONDS }, async (req, res) => {
    ...
    if (agentAddress === 'DEMO_FAIL_AGENT_NOT_TRUSTED' || agentAddress === 'DEMO_REJECTED_AGENT') {
        ...
        const policyResult = (0, policyEngine_1.evaluatePolicy)(policyName, evaluationContext);
